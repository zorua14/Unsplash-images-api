...
class ImagesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ImagesViewModel.shared.getImages(currentPage, self)
    ...
    @objc func refresh(_ sender: AnyObject) {
       // Code to refresh table view
        ...
        self.results = []
        self.filteredData = []
        ImagesViewModel.shared.getImages(currentPage, self,true)
    }
   ...
   @IBAction func buttonClicked(_ sender: UIBarButtonItem) {
    ...
    @IBAction func sortButton(_ sender: UIBarButtonItem){
        if selectedSort == false{
            ...
            sender.image = UIImage(named: "bio")
            ascendingSort(filteredData)
            selectedSort = true
        }
        else{
            
            sender.image = UIImage(named: "asc")
